...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if(!Creative.INSTANCE.modManager.chat.isEnabled()) {
    ...
    {
    	ChatComponentText message = new ChatComponentText(p_146227_1_.getFormattedText());
    	Creative.INSTANCE.modManager.autoGG.onChat(p_146227_1_);
    	if(Creative.INSTANCE.modManager.deobfnames.isEnabled()) {
    		message = new ChatComponentText(p_146227_1_.getFormattedText().replaceAll("§k", ""));
