...
import creativeclient.ui.CreativeMainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private int getScrollAmount() {
    	if (Creative.INSTANCE.modManager.zoom.isEnabled()) {
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(Creative.INSTANCE.modManager.perspective.getCameraYaw() + (Creative.INSTANCE.modManager.perspective.getCameraYaw() - Creative.INSTANCE.modManager.perspective.getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Creative.INSTANCE.modManager.perspective.getCameraPitch() + (Creative.INSTANCE.modManager.perspective.getCameraPitch() - Creative.INSTANCE.modManager.perspective.getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = Creative.INSTANCE.modManager.perspective.getCameraYaw();
                float f2 = Creative.INSTANCE.modManager.perspective.getCameraPitch();
                ...
                GlStateManager.rotate(Creative.INSTANCE.modManager.perspective.getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(Creative.INSTANCE.modManager.perspective.getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - Creative.INSTANCE.modManager.perspective.getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - Creative.INSTANCE.modManager.perspective.getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = Creative.INSTANCE.modManager.perspective.getCameraYaw() + (Creative.INSTANCE.modManager.perspective.getCameraYaw() - Creative.INSTANCE.modManager.perspective.getCameraYaw()) * partialTicks + 180.0F;
                float f7 = Creative.INSTANCE.modManager.perspective.getCameraPitch() + (Creative.INSTANCE.modManager.perspective.getCameraPitch() - Creative.INSTANCE.modManager.perspective.getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag && Creative.INSTANCE.modManager.perspective.overrideMouse())
        {
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof CreativeMainMenu)
        {
            this.updateMainMenu((CreativeMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(CreativeMainMenu currentScreen)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = CreativeMainMenu.class.getDeclaredFields();
