...
public class RenderManager
{
    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks)
    {
        ...
        {
        	this.playerViewY = Creative.INSTANCE.modManager.perspective.getCameraYaw() + (Creative.INSTANCE.modManager.perspective.getCameraYaw() - Creative.INSTANCE.modManager.perspective.getCameraYaw()) * partialTicks;
        	this.playerViewX = Creative.INSTANCE.modManager.perspective.getCameraPitch() + (Creative.INSTANCE.modManager.perspective.getCameraPitch() - Creative.INSTANCE.modManager.perspective.getCameraPitch()) * partialTicks;
        }
        ...
        try
        {
            ...
            if (render != null && this.renderEngine != null)
            {
                ...
                if (this.debugBoundingBox && !entity.isInvisible() && !p_147939_10_)
                {
                    try
                    {
                        this.renderDebugBoundingBox(entity, x, y, z, entityYaw, partialTicks, false);
                    }
     ...
     */
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_, boolean chroma)
    {
    	if(Creative.INSTANCE.modManager.hitbox.isEnabled()) {
    		int hitboxred, hitboxblue, hitboxgreen;
    		if(chroma) {
    			hitboxred = (int) RainbowColor.getColor().getRed();
	    		hitboxgreen = (int) RainbowColor.getColor().getGreen();
	    		hitboxblue = (int) RainbowColor.getColor().getBlue();
    		} else {
    			hitboxred = (int) Creative.INSTANCE.settingsManager.hitboxManager.red.getValue();
	    		hitboxgreen = (int) Creative.INSTANCE.settingsManager.hitboxManager.green.getValue();
	    		hitboxblue = (int) Creative.INSTANCE.settingsManager.hitboxManager.blue.getValue();
    		}
            ...
            RenderGlobal.func_181563_a(axisalignedbb1, hitboxred, hitboxgreen, hitboxblue, 255);
            ...
            if(Creative.INSTANCE.settingsManager.hitboxManager.eyeline.isEnabled()) {
