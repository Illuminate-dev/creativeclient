...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
    	RenderPlayerEvent e = new RenderPlayerEvent(entity, this, partialTicks, x, y, z);
    	e.call();
    	if(e.isCancelled()) {
    		return;
    	}
        ...
        if (!entity.isUser() || this.renderManager.livingPlayer == entity)
        {
            ...
            if (entity instanceof EntityPlayerSP) {
                float correctedY = 0.1f;
                if (entity.isSneaking()) correctedY = (float) 0.4;
                this.renderLivingLabel(entity, Minecraft.getMinecraft().thePlayer.getNameClear(), x, y - correctedY, z, 64);
             }
