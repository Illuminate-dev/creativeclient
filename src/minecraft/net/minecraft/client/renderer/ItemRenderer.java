...
public class ItemRenderer
{
    ...
    {
    	if(Creative.INSTANCE.modManager.itemModel.isEnabled()) {
    		float itemX = (float) (Creative.INSTANCE.settingsManager.itemModelManager.itemX.getValue() / 100);
    		float itemY = -((float) (Creative.INSTANCE.settingsManager.itemModelManager.itemY.getValue() / 100));
    		GlStateManager.translate(itemX, itemY, -0.71999997F);
            ...
            float size = (float) (Creative.INSTANCE.settingsManager.itemModelManager.size.getValue() / 100);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                if(!Creative.INSTANCE.modManager.animationsMod.isEnabled()) {
