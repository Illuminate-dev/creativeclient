...
import creativeclient.event.impl.OnMessageEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new CreativeMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    {
    	if(Creative.onRecieveChatMessage(packetIn)) {
    		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
            ...
            OnMessageEvent e = new OnMessageEvent(packetIn.getChatComponent());
            e.call();
    	}
