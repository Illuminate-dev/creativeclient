...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        SplashProgress.setProgress(1, "Model Manager");
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(2, "Render Item");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(3, "Render Manager");
        this.itemRenderer = new ItemRenderer(this);
        SplashProgress.setProgress(4, "Item Renderer");
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        SplashProgress.setProgress(5, "Entity Renderer");
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        SplashProgress.setProgress(6, "Render Global");
        ...
        Creative.INSTANCE.startup();

        if (this.serverName != null)
        {
            this.displayGuiScreen(new GuiConnecting(new CreativeMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new CreativeMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new CreativeMainMenu();
        }
        ...
        if (guiScreenIn instanceof CreativeMainMenu)
        {
            ...
            while (Mouse.next())
            {
                ...
                if (i1 <= 200L)
                {
                    ...
                    if (j != 0)
                    {
                        ...
                        {
                        	if (!Config.zoomMode || !Creative.INSTANCE.modManager.zoom.isEnabled()) {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (k == 48 && Keyboard.isKeyDown(61))
                        {
                            ...
                            Creative.INSTANCE.modManager.hitbox.setEnabled(this.renderManager.isDebugBoundingBox());
                        }
