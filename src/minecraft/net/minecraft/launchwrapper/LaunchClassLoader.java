...
public class LaunchClassLoader extends URLClassLoader {
   ...
   public Class findClass(String name) throws ClassNotFoundException {
      if(this.invalidClasses.contains(name)) {
         ...
         for(Object exception : this.classLoaderExceptions) {
            if(name.startsWith((String) exception)) {
         ...
         if(this.cachedClasses.containsKey(name)) {
            ...
            for(Object exception : this.transformerExceptions) {
               if(name.startsWith((String)exception)) {
                  try {
   ...
   private byte[] runTransformers(String name, String transformedName, byte[] basicClass) {
      if(DEBUG_FINER) {
         ...
         for(IClassTransformer transformer : (ArrayList<IClassTransformer>) this.transformers) {
