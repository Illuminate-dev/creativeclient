...
public class DraggableComponent {
    ...
    public void draw(int mouseX, int mouseY, String name){
        ...
        if(mouseOverX && mouseOverY) {
            if(Mouse.isButtonDown(0)){
                if (!this.dragging) {
                	if(Creative.INSTANCE.currentlydragging == null || Creative.INSTANCE.currentlydragging.equals(name)) {
		            	Creative.INSTANCE.currentlydragging = name;
		        		this.lastX = x - mouseX;
		                this.lastY = y - mouseY;
		                this.dragging = true;
                	}
            	...
            	Creative.INSTANCE.currentlydragging = null;
            }
        }
    }
