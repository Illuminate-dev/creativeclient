package creativeclient.cosmetics;
...
import creativeclient.util.UrlTextureUtil;
import creativeclient.util.UrlTextureUtil.ResourceLocationCallback;

public class CosmeticWingsURL extends ModelBase{
	...
	private void renderWingsIn3D(WorldRenderer worldrenderer) {
	   ...
	   public void RenderWings(boolean isSneaking, Entity entityIn, int id) {
		   ...
		   if(img == null && !hasTriedToDownload) {
				...
				UrlTextureUtil.downloadAndSetTexture("https://github.com/anKordii/CosmeticsWings/raw/master/texture.png", new ResourceLocationCallback() {
					// + id + "
