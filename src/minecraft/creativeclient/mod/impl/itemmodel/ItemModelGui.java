...
public class ItemModelGui extends ModGui {
	...
	public void initGui() {
		...
		numberButtons.add(new NumberButton(900, 135, 100, 100, 20, Creative.INSTANCE.settingsManager.itemModelManager.itemX));
		numberButtons.add(new NumberButton(900, 135, 130, 100, 20, Creative.INSTANCE.settingsManager.itemModelManager.itemY));
		numberButtons.add(new NumberButton(900, 135, 160, 100, 20, Creative.INSTANCE.settingsManager.itemModelManager.size));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "ItemModel", (int) (Math.round(135 * 0.76923076923)),
